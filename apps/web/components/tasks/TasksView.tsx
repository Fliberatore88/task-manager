  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg-base)' }}>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-1.5 text-sm font-medium text-white rounded-lg transition-all"
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-5">
        ...
        {error && (
          <div
            className="rounded-xl px-4 py-3 text-sm flex items-center gap-2 animate-slide-in"
            style={{
        ...
        {loading ? (
          ...
          <div className="text-center py-20 animate-fade-in-up">
            ...
            <h3 className="font-medium mb-1" style={{ color: 'var(--text-primary)' }}>No tasks found</h3>
      ...
      <Modal
        ...
        title="New Task"
      >
        {formError && <p className="text-xs text-red-400 mb-3 -mt-1">{formError}</p>}
        <TaskForm
